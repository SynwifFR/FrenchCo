    ...
    function(data, menu)
      if data.current.value == 'vehicle_list' then
        ...
        if Config.EnableSocietyOwnedVehicles then
            ...
            ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(vehicles)
              ...
              ESX.UI.Menu.Open(
                ...
                function(data, menu)
                  ...
                  SetVehicleNumberPlateText(vehicle, "RED" .. platenum)
            ...
            local elements = {
              {label = 'Livraison', value = 'Pounder'},
              {label = 'Véhicule pour apprenti', value = 'bison'},
              {label = 'Véhicule pour employé(e)', value = 'rebel'}
            }

            if Config.EnablePlayerManagement and PlayerData.job ~= nil and
              (PlayerData.job.grade_name == 'boss') then
              table.insert(elements, {label = 'Véhicule Patron', value = 'gauntlet2'})
            end
...
function OpenTabacCraft2Menu()
  if Config.EnablePlayerManagement and PlayerData.job ~= nil then
    ...
    local elements = {
      {label = 'REDWOOD', value = 'malbora'},
      {label = 'REDWOOD CIGAR', value = 'gitanes'}
